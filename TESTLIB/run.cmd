...
IF "%eclipsehome%"=="" (
 set eclipsehome=C:/SoftwareAG/Designer/eclipse/
)
...
IF "%java%"=="" (
  set java=C:\SoftwareAG\jvm\jvm\jre\bin\java.exe
)

IF "%eclipseworkspace%"=="" (
  set eclipseworkspace=C:/Training/310-71E/Student/hello_world_workspace
)

IF "%buildfile%"=="" (
  set buildfile=C:\Training\initial_demo_git\natural-initial-demo-project\TESTLIB\build.xml
)
